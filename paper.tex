...
\includegraphics[!ht]{Chromospheric_shadow.eps}
...
\includegraphics[trim = 1in 6in 2in 0.5in,clip,width=3 in]{comp_size.eps}
...
\includegraphics[trim = 1in 6in 2in 0.5in,clip,width=3 in]{chromosphere_surface_brightness.eps}
...
\includegraphics[trim = 1in 6in 2in 0.5in,clip,width=3 in]{lc_h.1_p.1.eps}
